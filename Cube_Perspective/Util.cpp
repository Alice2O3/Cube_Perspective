...
const double Util::Pi2 = Util::Pi / 2;
const double Util::Pi180 = Util::Pi / 180;
const double Util::Pi180r = 180 / Util::Pi;
...
float Util::BoundRange(const float& x, const float& max_value) {
	float ret = x;
	if (ret > max_value) {
		ret = max_value;
	}
